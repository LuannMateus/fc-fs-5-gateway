...
func TestCreditCardNumber(t *testing.T) {
	_, err := NewCreditCard("40000000000000", "John Doe", 12, 2024, 123)
...
func TestCreditCardExpirationYear(t *testing.T) {
	invalidLastYear := time.Now().AddDate(-1, 0, 0)

	_, err := NewCreditCard("4193523830170205", "John Doe", 12, invalidLastYear.Year(), 123)
